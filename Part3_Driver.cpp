...
int main() {
	...
	cityNameIDPair.insert(pair<string, int>("Pittsburch", 4));
	...
	addEdge(&myGameMap, "Washington DC", "Pittsburch", 6, cityNameIDPair);
	addEdge(&myGameMap, "Pittsburch", "Detroit", 6, cityNameIDPair);
	addEdge(&myGameMap, "Detroit", "Buffalo", 7, cityNameIDPair);
	addEdge(&myGameMap, "Buffalo", "Pittsburch", 7, cityNameIDPair);
